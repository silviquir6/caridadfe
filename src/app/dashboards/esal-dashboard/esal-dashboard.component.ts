...
@Component({
  selector: 'app-esal-dashboard',
  templateUrl: './esal-dashboard.component.html',
  styleUrls: ['./esal-dashboard.component.css']
})
export class EsalDashboardComponent implements OnInit {
